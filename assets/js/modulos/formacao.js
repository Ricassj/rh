$(function () {
    ...
    function formataTags() {
        ...
        _tags = '<section class="remove_section' + campo_inicial + '">'
                ...
                + '             <select class="form-control text-center" name="FORMACAO[formacao][]" id="_selectFormacao' + campo_inicial + '" >'
                ...
                + '    <div class="col-xs-12 col-md-12">'
                + '        <div class="form-group">'
                + '            <a href="javascript:void(0)" class="btn btn-danger remover_campo" id="remove_section' + campo_inicial + '">- Remover Formação</a>'
                + '        </div>'
                + '    </div>'
                + '</div>'
                + '</section>';
